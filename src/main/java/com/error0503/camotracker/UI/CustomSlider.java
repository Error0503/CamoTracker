...
class CustomSlider extends BasicSliderUI {
    ...
    private static final Dimension THUMB_SIZE = new Dimension(10, 8);
    private final Rectangle2D.Float trackShape = new Rectangle2D.Float();
    ...
    public void paintTrack(final Graphics g) {
        ...
        // Paint shadow.
        g2.setColor(new Color(39, 39, 57));
        g2.fill(trackShape);

        // Paint track background.
        g2.setColor(new Color(29, 29, 42));
    ...
    public void paintThumb(final Graphics g) {
        g.setColor(new Color(148, 148, 150));
